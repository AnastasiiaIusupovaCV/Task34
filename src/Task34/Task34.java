 ...
 * @author a.yusupova
 */
public class Task34 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Task34.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
